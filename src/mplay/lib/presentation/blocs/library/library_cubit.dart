...
class LibraryCubit extends Cubit<LibraryState> {
  ...
  Future<void> loadLibrary({
    ...
    try {
      ...
      final customPlaylists = await _playlistService.loadCustomPlaylists(
        tracks,
      );
      ...
      print(
        'LibraryCubit: ${tracks.length} tracks, ${albums.length} albums, ${artists.length} artists',
      );
    } catch (e) {
  ...
  Future<void> refreshLibrary() async {
    await loadLibrary(forceRefresh: true, showLoading: state.tracks.isEmpty);
  }
